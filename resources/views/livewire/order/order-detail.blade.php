                        ...
                        @elseif(Auth::id() === $order->buyer_id)
                            ...
                            <form wire:submit.prevent="submitReview" class="bg-white p-4 border border-gray-200 rounded-md shadow-sm">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea id="comment" wire:model="comment" rows="3" class="shadow-sm focus:ring-primary-500 focus:border-primary-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Tell us what you think about this item and seller..."></textarea>
